      ...
      <div className="w-full h-screen flex flex-col md:flex-row items-start">
        <div className="relative w-full md:w-1/2  h-1/2 md:h-full flex flex-col">
          <div className="absolute top-[20%] left-[10%] flex flex-col">
            <h1 className="text-4xl text-white font-bold my-2 mt-32">
              CarWash
            </h1>
        ...
        <div className="w-full md:w-1/2 h-full bg-white flex flex-col p-20 justify-between">
          ...
          <div className="w-full flex flex-col max-w-[550px]">
            ...
            <div className="w-full flex flex-col">
              ...
              <input
                className="w-full text-black py-2 my-4 border-b border-black outline-none focus:outline-none p-4 bg-none"
                type="email"
                id="email"
                value={email}
            ...
            <div className="w-full flex flex-col mt-3 relative">
              ...
              <button
                ...
                className="absolute right-0 top-0 mt-7 mr-2 flex items-center"
              >
                {showpassword ? <IoMdEye className="w-10 h-6" /> : <IoMdEyeOff className="w-10 h-6" />}
              </button>
