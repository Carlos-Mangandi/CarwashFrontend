            ...
            <p className="text-base sm:text-lg lg:text-xl text-gray-600 mb-4">Esta seguro de eliminar el registro esta opción no se puede revertir.</p>
              <div className="flex justify-center">
                <button
                  ...
                  className="bg-red-700 hover:bg-red-600 text-white  py-2 px-4 rounded-2xl mr-4"
                >
                  Eliminar
                </button>
                <button
                  onClick={cancelDelete}
                  className="bg-gray-900 hover:bg-black text-white font-bold py-2 px-4 rounded-2xl"
                >
                  Cancelar
                </button>
              </div>
